...
const API_URL_PLAYLIST = "http://127.0.0.1:5000/recommend_playlist";
    ...
    <div className="app">
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <span className="relative text-black group-hover:text-white">Recommend Songs</span>
        </button>
        <button
        ...
        >
          <div className="absolute inset-0 w-3 bg-amber-400 transition-all duration-[250ms] ease-out group-hover:w-full"></div>
          <span className="relative text-black group-hover:text-white">Recommend Playlist</span>
        </button>
      </div>
